<?
//output you should get from the sample
//added < ?    ? > marks and commented SQL at the bottom
...
/*
CREATE TABLE person ( p_id int(6) NOT NULL AUTO_INCREMENT , p_name char(8), p_addr text, p_country text, p_status char(1), PRIMARY KEY (p_id));
*/
?>