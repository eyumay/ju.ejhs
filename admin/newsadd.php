                ...
                <td colspan="2" rowspan="2" valign="top">
					...
					<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
					  <table width="560" height="422" border="0" cellspacing="0" style="border:#CCCCCC solid 1px;">
						...
						<tr>
						  <td bgcolor="#F3F3F3">Related Link </td>
						...
						<tr>
						  <td bgcolor="#F3F3F3">Promoted to Front page </td>
						  <td bgcolor="#F3F3F3"><label>
						    <input type="checkbox" name="checkbox" value="checkbox" />
						  </label></td>
					    </tr>
						<tr>
						  <td bgcolor="#F3F3F3">&nbsp;</td>
						  <td bgcolor="#F3F3F3"><input name="upload_news" type="submit" id="upload_news" value="Submit" /></td>
					    </tr>
					  </table>
					</form>					
                </td>
