...
function delArticle(id, title)
{
    ...
    {
        window.location.href = 'searchengineEdit.php?del=' + id;
    }
}
</script>
...
<div id="container">
  ...
  <tr>
    ...
    <td width="41%" bgcolor="#D8D7D6">&nbsp;</td>
  						...
  						<?php
						$query =  "select * from searchengine order by id desc";
  ...
  <tr>
    ...
    <td valign="top">&nbsp;</td>
    <td valign="top"> <a href= "searchengineUpdate.php?editNews=<?php echo $id;?>">  Edit </a></td>
