...
if(isset($_GET['del']))
{
    ...
    $query = "DELETE FROM user WHERE id = '{$_GET['del']}'";
...
function delArticle(id, title)
{
    ...
    {
        window.location.href = 'useedit.php?del=' + id;
    }
}
</script>
...
<div id="container">
            ...
            <td valign="top"><table width="100%" border="0">
              <tr>
				...
				<table width="100%" border="0" cellspacing="0">
					...
					<h3>Manage Users </h3>
					<p><a href="useAdd.php">+Add New User</a> </p>
					<table width="100%" border="0" cellspacing="1">
  <tr>
    <td width="2%">&nbsp;</td>
    <td width="31%"><strong>Title of the News </strong></td>
    <td width="1%">&nbsp;</td>
    ...
    <td width="51%">&nbsp;</td>
  						...
  						<?php
						$query =  "select * from user where privilege_id = 3 order by id desc";
  ...
  <tr>
    <td valign="top">»</td>
    <td valign="top"> <?php echo $row['first_name']. " " . $row['last_name']; ?></td>
    <td valign="top">&nbsp;</td>
    <td valign="top"> <a href= "useupdate.php?editUser=<?php echo $id;?>">  Edit </a></td>
    <td valign="top"><a href="javascript:delArticle('<?php echo $id;?>', '<?php echo $first_name." ".$last_name;?>');">Delete</a></td>
    <td valign="top"><a href= "usechangepass.php?editUser=<?php echo $id;?>">Change Password</a></td>
  </tr>
  								<?php
							}
              ...
              <tr>
                <td>&nbsp;</td>
                <td width="48%"><a href="useAdd.php">+Add New User</a></td>
                <td width="48%">&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
