...
if(isset($_POST['upload_journal']))
{
	...
	{								
		...
		if( EJHSJournal::update($year_of_edition, $month, $vol, $num, $issn, $eissn, $new_upload_dir, $fileName, $updateID) &&
			EJHSJournalArticle::updateArticleUploadDir($updateID, $new_upload_dir) )
		{
