...
/* $Id: haru.c,v 1.27 2008/09/17 08:41:34 tony2001 Exp $ */
...
static zend_function_entry harudoc_methods[] = { /* {{{ */
	...
	PHP_ME(HaruDoc, getEncoder, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, getCurrentEncoder, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, setCurrentEncoder, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, setPageLayout, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, getPageLayout, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, setPageMode, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, getPageMode, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, setInfoAttr, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, setInfoDateAttr, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, getInfoAttr, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, getFont, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, loadTTF, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, loadTTC, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, loadType1, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, loadPNG, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, loadJPEG, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, loadRaw, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, setPassword, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, setPermission, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, setEncryptionMode, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, setCompressionMode, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, setPagesConfiguration, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, setOpenAction, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, createOutline, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, addPageLabel, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, useJPFonts, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, useJPEncodings, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, useKRFonts, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, useKREncodings, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, useCNSFonts, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, useCNSEncodings, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, useCNTFonts, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruDoc, useCNTEncodings, NULL, ZEND_ACC_PUBLIC)
	{NULL, NULL, NULL}
};
/* }}} */
...
static zend_function_entry harupage_methods[] = { /* {{{ */
	...
	PHP_ME(HaruPage, eofill, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, lineTo, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, curveTo, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, curveTo2, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, curveTo3, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, rectangle, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, arc, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, circle, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, showText, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, showTextNextLine, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, textOut, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, beginText, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, endText, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setFontAndSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setCharSpace, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setWordSpace, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setHorizontalScaling, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setTextLeading, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setTextRenderingMode, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setTextRise, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, moveTextPos, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, fillStroke, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, eoFillStroke, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, closePath, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, endPath, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, ellipse, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, textRect, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, moveToNextLine, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setGrayFill, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setGrayStroke, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setRGBFill, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setRGBStroke, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setCMYKFill, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setCMYKStroke, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setWidth, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setHeight, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setRotate, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getWidth, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getHeight, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, createDestination, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, createTextAnnotation, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, createLinkAnnotation, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, createURLAnnotation, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getTextWidth, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, MeasureText, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getGMode, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getCurrentPos, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getCurrentTextPos, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getCurrentFont, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getCurrentFontSize, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getLineWidth, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getLineCap, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(HaruPage, getTextLeading, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getTextRenderingMode, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getTextRise, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getRGBFill, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getRGBStroke, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getCMYKFill, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getCMYKStroke, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getGrayFill, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getGrayStroke, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getFillingColorSpace, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, getStrokingColorSpace, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruPage, setSlideShow, NULL, ZEND_ACC_PUBLIC)
	{NULL, NULL, NULL}
};
/* }}} */
...
static zend_function_entry harufont_methods[] = { /* {{{ */
	...
	PHP_ME(HaruFont, getAscent, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruFont, getDescent, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruFont, getXHeight, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruFont, getCapHeight, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruFont, getTextWidth, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruFont, MeasureText, NULL, ZEND_ACC_PUBLIC)
	{NULL, NULL, NULL}
};
/* }}} */
...
static zend_function_entry haruimage_methods[] = { /* {{{ */
	...
	PHP_ME(HaruImage, getBitsPerComponent, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruImage, getColorSpace, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruImage, setColorMask, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(HaruImage, setMaskImage, NULL, ZEND_ACC_PUBLIC)
	{NULL, NULL, NULL}
};
/* }}} */
...
static zend_function_entry haruannotation_methods[] = { /* {{{ */
	...
	PHP_ME(HaruAnnotation, setOpened, NULL, ZEND_ACC_PUBLIC)
	{NULL, NULL, NULL}
};
/* }}} */
...
static zend_function_entry haruencoder_methods[] = { /* {{{ */
	...
	PHP_ME(HaruEncoder, getWritingMode, NULL, ZEND_ACC_PUBLIC)
	{NULL, NULL, NULL}
};
/* }}} */
